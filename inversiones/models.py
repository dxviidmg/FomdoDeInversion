...
class Inversion(models.Model):
	...
	comprobante = models.ImageField(upload_to='inversion/comprobantes/%Y/%m/%d/', null=True, blank=True)
	...
	cantidad_a_deber = models.DecimalField(max_digits=20,decimal_places=2, default=0)
	...
	def CalculaPorcentaje(self):
		...
		self.cantidad_a_deber = self.devolucion - suma_pagos_dict['cantidad__sum']		
		self.save()
